    ...
    >
      ...
      >
        <Box p={{base: '80px 20px 30px', d:'120px 0px  60px 190px'}}>
          ...
          <Box px={{base: '10px', d:0}} overflow='hidden'>
            <Mover x={isWide ? [-10, -15] : [0,0]}>
              <Box ref={slider1Ref} className="swiper-container slider1" pl={{d:'100px', wide:0}}>
            ...
            <Box pos='relative' p={{base: '40px 0 100px', d:'60px 0 120px'}}
              sx={{
                maxW: {md: '367px'},
